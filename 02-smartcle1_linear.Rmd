...
#### How many respondents had exercised in the past 30 days?

```{r eda_exerany_smartcle2}
...
```{r eda_physhealth_smartcle2_head}
...
#### Comparing `physhealth` summaries by obesity status

Can we compare the `physhealth` means, medians and 75^th^ percentiles for respondents whose BMI is below 30 to the respondents whose BMI is not?
