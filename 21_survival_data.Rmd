...
```{r km plot for hemfit2}
plot(hemfit2, main="Kaplan-Meier Curve by Genotype", 
     ylab="Probability of Hemorrhage-Free Survival", 
     xlab="Months of Follow-Up", col=c(1,2), lty=c(1,2))
legend(5,.4, legend=c(
  expression(paste("Homozygous ", epsilon, "3 / ", 
                   epsilon, "3")), 
  expression(paste("At least one ", epsilon,"2 or ",
                   epsilon,"4 Allele"))), 
  text.col=c(1,2), col=c(1,2), lty=c(1,2), bty="n")
```
...
### Plotting the K-M comparison with `ggsurvplot`
