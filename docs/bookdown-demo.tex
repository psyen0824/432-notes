...
\setlength{\droptitle}{-2em}
  ...
  \postdate{\par}
  \date{Built 2018-01-22 10:12:23}
...
\chapter{Analysis of Variance and Analysis of
Covariance}\label{analysis-of-variance-and-analysis-of-covariance}
...
\section{An Emphysema Study: Analysis of
Covariance}\label{an-emphysema-study-analysis-of-covariance}
...
\subsection{\texorpdfstring{Does \texttt{sex} affect the mean change in
...
\subsection{\texorpdfstring{Is there an association between \texttt{age}
...
\subsection{\texorpdfstring{Adding a quantitative covariate,
\texttt{age}, to the
...
\subsubsection{The ANCOVA model}\label{the-ancova-model}
...
\subsubsection{The ANCOVA Table}\label{the-ancova-table}
...
\subsection{Rerunning the ANCOVA model after simple
...
\subsection{Looking at a factor-covariate
...
\subsection{Centering the Covariate to Facilitate ANOVA
Interpretation}\label{centering-the-covariate-to-facilitate-anova-interpretation}
...
into a separate training and test samples, and then:
...
testing down. A potential solution is the idea of cross-validation,
...
So we'll need some additional methods for selecting variables, and for
then validating the results once we complete the selection process.
